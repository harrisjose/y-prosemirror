...
var prng__namespace = /*#__PURE__*/_interopNamespace(prng);
 ...
 * @return {boolean}
 */
const equalAttrs$1 = (a, b) => a === b || (typeof a === 'object' && typeof b === 'object' && a && b && object__namespace.equalFlat(a, b));
 ...
 * @public
 */
new prosemirrorState.PluginKey('yjs-cursor');
...
const schema$1 = new PModel.Schema({ nodes, marks });
...
const pmChanges = [
  ...
  (_y, gen, p) => { // wrap in blockquote
    ...
    const wrapping = range && prosemirrorTransform.findWrapping(range, schema.nodes.blockquote);
    if (wrapping) {
